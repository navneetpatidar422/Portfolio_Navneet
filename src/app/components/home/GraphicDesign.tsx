...
export const GraphicDesign = () => {
  return (
    <section id="graphic-design" className="py-24 lg:py-32 px-6 bg-transparent text-[#111111] relative">
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-display font-medium leading-tight text-neutral-900 tracking-tight uppercase">
            Visual<br />Explorations.
          </h2>
          <p className="mt-6 text-lg md:text-xl text-neutral-500 font-light max-w-2xl">
        ...
        <div className="columns-2 lg:columns-3 gap-4 md:gap-6 space-y-4 md:space-y-6">
          {galleryItems.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative w-full rounded-2xl overflow-hidden group cursor-pointer break-inside-avoid shadow-sm border border-black/5"
            >
