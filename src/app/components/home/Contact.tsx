                        ...
                        <div className="space-y-8 mb-12">
                            ...
                            >
                                <div className="relative">
                                    <div className="p-4 rounded-full bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 group-hover:border-[#10B981] group-hover:bg-[#10B981] transition-all duration-300 shadow-sm">
                                        <Mail className="w-6 h-6 text-foreground group-hover:text-white transition-colors" />
                                    </div>
                                </div>
                                <div>
                                    <p className="text-xs text-neutral-500 dark:text-neutral-400 uppercase tracking-widest font-subheading font-bold mb-1 transition-colors">Email Me</p>
                                    <div className="flex items-center gap-3 font-body">
                                        <span className="text-sm md:text-base font-bold text-foreground group-hover:text-[#10B981] transition-colors block">
                                            designer.navneet.patidar@gmail.com
                                        </span>
                                        <motion.div
                                            initial={{ opacity: 0, scale: 0.5 }}
                                            animate={{ opacity: copiedEmail ? 1 : 0, scale: copiedEmail ? 1 : 0.5 }}
                                            className="p-1 rounded-full bg-emerald-500/20 shrink-0"
                                        >
                                            <Check className="w-4 h-4 text-emerald-500" />
                                        </motion.div>
                                        {!copiedEmail && <Copy className="w-4 h-4 text-neutral-400 dark:text-neutral-500 group-hover:text-emerald-500 transition-colors opacity-0 group-hover:opacity-100 shrink-0" />}
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div>
                                    <p className="text-xs text-neutral-500 dark:text-neutral-400 uppercase tracking-widest font-subheading font-bold mb-1 transition-colors">Call Me</p>
                                    <span className="text-sm md:text-base font-bold text-foreground group-hover:text-[#10B981] transition-colors font-body">
                                        +91 7878913449
                                    </span>
                                </div>
                            </div>
